        ...
        <ul class="nav">
          ...
          <li class="nav-item pt-3">
            <a class="nav-link d-block" href="index.html">
              <img class="sidebar-brand-logo" src="{{ asset('home/img/logo/11.png') }}" style="width: 150px;" alt="" />
              <img class="sidebar-brand-logomini" src="{{ asset('home/img/logo/11logo.png') }}" alt="" />
